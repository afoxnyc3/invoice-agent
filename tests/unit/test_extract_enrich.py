...
class TestExtractEnrich:
    ...
    def test_extract_enrich_known_vendor(self, mock_table_service):
        ...
        mock_table_client.get_entity.assert_called_once_with(partition_key="Vendor", row_key="adobe_com")
    ...
    def test_extract_enrich_table_lookup(self, mock_table_service):
        ...
        mock_table_client.get_entity.assert_called_once_with(partition_key="Vendor", row_key="microsoft_com")
